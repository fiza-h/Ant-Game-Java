...
//
//public class AntSinusoidal extends JPanel implements ActionListener, MouseInputListener, MouseListener, MouseMotionListener, KeyListener
//{
...
//            }
//            else ants.add(new WavyAnt(random.nextInt(getWidth()), getHeight()));
//
//
//        double choice = Math.random();
//        for (int i = ants.size() - 1; i >= 0; i--) {
//            Ant ant = ants.get(i);
//            if (ant instanceof WavyAnt)
//            {
//                ((WavyAnt) ant).moveWavy();
//            }
//            else ant.moveUp();
//
//            /**
